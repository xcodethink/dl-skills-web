...
description: Extracts and analyzes competitors' ads from ad libraries to reveal effective messaging, creative patterns, and audience targeting strategies.
---
...
This skill scrapes competitor advertisements from platform ad libraries (Facebook, LinkedIn, etc.) and analyzes what is working -- the problems highlighted, use cases targeted, and copy/creative approaches that resonate. It helps you build data-driven ad campaigns informed by proven market patterns rather than guesswork.

## When to Use

- Researching competitor ad strategies before launching campaigns
- Finding inspiration and proven patterns for your own ads
- Understanding market positioning across your competitive set
- Identifying successful messaging, pain points, and creative formats
- Planning ad campaigns with concepts validated by competitor data

## What It Does

1. **Extracts Ads** -- Scrapes ads from Facebook Ad Library, LinkedIn, and similar platforms
...
5. **Identifies Patterns** -- Finds common successful approaches across the competitive set
...
**Prompt**: "Extract ads from Notion on Facebook Ad Library and tell me what messaging is working for them."
...
### Messaging Analysis
- What problems competitors emphasize
- How they position against the competition
